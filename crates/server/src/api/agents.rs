...
impl CreateAgentRequest {
    ...
    fn into_yaml_config(self) -> Result<AgentYamlConfig, String> {
...
fn require_agent_store(
    state: &AppState,
) -> Result<&Arc<stupid_agent::AgentStore>, (axum::http::StatusCode, Json<QueryErrorResponse>)> {
